...
We provide the visualization results of **URMCNet-B** and **URMCNet-L** tested on the VITLD dataset. All result files are hosted on Baidu Netdisk.

> * Test results corresponding to multiple training weights are provided.
> * The original and merged VITLD results are provided..
...
* **Learning Rate:** Initial LR `3e-4` with Polynomial Decay scheduler (`power=0.9 or 0.7`).
